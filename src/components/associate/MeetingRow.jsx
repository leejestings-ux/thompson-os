  ...
  return (
    <div className="flex items-center gap-4 px-5 py-3.5">
      ...
      <button
        ...
        className="text-sm font-semibold text-navy hover:text-navy-light transition-colors text-left min-w-0 shrink-0"
      >
        {donor.name}
      </button>
      ...
      <span
        className={`text-[11px] font-semibold px-2.5 py-0.5 rounded-full whitespace-nowrap ${
          TYPE_STYLES[meeting.type] || 'bg-slate-100 text-slate-600'
        }`}
      >
        {meeting.type}
      </span>
